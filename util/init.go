...
const SchemaMetaInsert = "INSERT INTO SchemaMetaInsert (app, nickname, alias, feip, `user`, password, feport, address, expire, status, fe_log_path, be_log_path, be_meta_log, java_udf_path, manager_access_key, manager_secret_key) VALUES('sr-test', 'StarRocks(Tencent Cloud) SR-TEST', NULL, '127.0.0.1', 'chengkenli', 'lizhenghua1.', 9030, 'http://127.0.0.1:19321', 30, 0, NULL, NULL, NULL, NULL, NULL, NULL)"
