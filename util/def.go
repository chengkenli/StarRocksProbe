...
var Lastcache = cache.New(24*time.Hour, 24*time.Hour)
...
type NumRunProcess struct {
	IP                string  `json:"IP"`
	Alive             string  `json:"Alive"`
	NumRunningQueries int     `json:"NumRunningQueries"`
...
type ReadInConf struct {
	...
	Schema struct {
		...
		GrowthInfo   string   `json:"growth_info"`
		FilterErrmsg string   `json:"filter_errmsg"`
	} `json:"schema"`
	Category struct {
		Num0 []string `json:"0"`
		Num1 []string `json:"1"`
...
type RunQueries struct {
	Dop             string `json:"DOP"`
	FeStartTime     string `json:"FeStartTime"`
...
type TaskOptimize struct {
	JobId         interface{} `bson:"JobId"`
	TableName     interface{} `bson:"TableName"`
	CreateTime    interface{} `bson:"CreateTime"`
	Operation     interface{} `bson:"Operation"`
	TransactionId interface{} `bson:"TransactionId"`
	State         interface{} `bson:"State"`
	Msg           interface{} `bson:"Msg"`
	Progress      interface{} `bson:"Progress"`
	Timeout       interface{} `bson:"Timeout"`
	// 自定义
	Tag     string
	Command string
}
type TaskOptimizeErr struct {
	JobId         interface{} `bson:"JobId"`
	TableName     interface{} `bson:"TableName"`
	CreateTime    interface{} `bson:"CreateTime"`
	Operation     interface{} `bson:"Operation"`
...
type AppStates struct {
	ServiceDetectStatus int `json:"ServiceDetectStatus"`
	//UnKnown     States
	//AllHealthy  States
	//PartHealthy States
	//UnHealthy   States
